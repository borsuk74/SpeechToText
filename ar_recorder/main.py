...
version.
It uses jnius which is fasade to java libraries on Android.
It could be used as a frame for actual kivy application, when combined
with native google_speech functionality.
